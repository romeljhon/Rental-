...
const initialItems: RentalItem[] = [
  ...
  { id: '5', name: 'Cozy Downtown Apartment', description: '1-bedroom apartment in the heart of the city. Fully furnished with modern amenities.', category: 'Property', pricePerDay: 120, imageUrl: 'https://placehold.co/600x400.png', availabilityStatus: 'Available', owner: mockUser, location: 'San Francisco, CA', rating: 4.7, reviewsCount: 18, features: ['Sleeps 2', 'WiFi', 'Kitchenette'], deliveryMethod: 'Pick Up' },
  { id: '6', name: 'Heavy Duty Power Drill', description: 'Cordless power drill with multiple bits. Ideal for DIY projects.', category: 'Tools', pricePerDay: 25, imageUrl: 'https://placehold.co/600x400.png', availabilityStatus: 'Unavailable', owner: mockUser, location: 'Austin, TX', rating: 4.3, reviewsCount: 10, deliveryMethod: 'Pick Up' },
];
