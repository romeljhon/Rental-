...
export default async function ItemDetailPage({ params }: { params: { id: string } }) {
  ...
  if (!item) {
    // If you want to use Next.js's built-in notFound, you can do this:
    // notFound();
    // For a custom message within the layout:
    return (
...
// Optional: Generate static paths if you have a known set of items
