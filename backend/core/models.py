...
class Item(models.Model):
    ...
    owner_id = models.CharField(max_length=100, default='user123')
...
class RentalRequest(models.Model):
    ...
    requester_id = models.CharField(max_length=100, default='user123') # Added to match frontend IDs
    owner_id = models.CharField(max_length=100, default='user456') # Added to match frontend IDs
